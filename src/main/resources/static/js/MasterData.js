...
function DashboardCreationExcel2(Obj) {
	...
	window.location.href = "http://localhost:9082/RealTimeDataValues/PostGetDashboardGridToExcel2";
...
function OpenPopup(obj) {
	...
	const myWindow = window.open("http://localhost:9080/GetLocationlist", "", "width=500,height=100");
...
function BotNameData() {
	...
	$.ajax({
		type: 'GET',
		url: 'http://localhost:9082/GetBotNamelist',
		dataType: 'json',
		async: true,
...
function RealTimeData() {
	...
	$.ajax({
		...
		url: 'http://localhost:9082/GetDurationTime',
		type: "POST",
...
function DepartmentData() {
	...
	$.ajax({
		type: 'GET',
		url: 'http://localhost:9082/GetDepartmentlist',
		dataType: 'json',
		async: true,
		success: function(resultR) {
			//alert(result.length);
...
function InvokeMethod(Obj) {
	...
	$.ajax({
		type: 'GET',
		url: 'http://localhost:9082/GetLocationlist',
		dataType: 'json',
		async: true,
...
function DashboardCreation(obj) {
	...
	$.ajax({
		url: "http://localhost:9082/PostGetDashboardChart",
		type: "POST",
		contentType: 'application/json; charset=utf-8',
		dataType: 'json',
		data: JSON.stringify(postData),
...
//-----------------------added code by kiran start ----------------------
function UpadteDashboardCreation(obj) {
	console.log("updatePieChart");
	// Hide the existing chart
	// $('#pieChart11').hide();
